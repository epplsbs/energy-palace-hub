...
export const createPosOrder = async (order: Omit<PosOrder, 'id' | 'created_at' | 'completed_at'>) => {
  // Include order_number as empty string - it will be auto-generated by the trigger
...
export const createPosChargingOrder = async (order: Omit<PosChargingOrder, 'id' | 'created_at'>) => {
  // Include order_number as empty string - it will be auto-generated by the trigger
  const orderWithNumber = {
    ...order,
    order_number: ''
