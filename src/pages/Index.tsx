...
const Index = () => {
  ...
  return (
    ...
    >
      ...
      {!(businessSettings?.background_image_url || backgroundImageUrl) && (
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-im[...]
      )}
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <h1 className={`text-6xl md:text-8xl font-black leading-tight ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>
              <span className={`block ${theme === 'light' ? 'bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent' : 'bg-gradient-to-r from-emerald-400 via-blue-4[...]
                Charge
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {/* Book Charger */}
            <div className={`glass rounded-2xl p-8 border ${theme === 'light' ? 'border-gray-200 bg-white/50' : 'border-white/20'} hover:border-emerald-500/50 transition-all duration-300 hover:scale-1[...]
              <div className="flex flex-col items-center space-y-4">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold py-3 rounded-xl transition-all duration-300 sh[...]
                >
                  <span>Book Now</span>
            ...
            {/* Menu */}
            <div className={`glass rounded-2xl p-8 border ${theme === 'light' ? 'border-gray-200 bg-white/50' : 'border-white/20'} hover:border-blue-500/50 transition-all duration-300 hover:scale-105 [...]
              <div className="flex flex-col items-center space-y-4">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 rounded-xl transition-all duration-300 shadow-lg hove[...]
                >
                  <span>View Menu</span>
                  <ChevronRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
            ...
            {/* Reserve Now */}
            <div className={`glass rounded-2xl p-8 border ${theme === 'light' ? 'border-gray-200 bg-white/50' : 'border-white/20'} hover:border-purple-500/50 transition-all duration-300 hover:scale-10[...]
              <div className="flex flex-col items-center space-y-4">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold py-3 rounded-xl transition-all duration-300 shadow[...]
                >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`text-5xl font-bold mb-6 ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>
              <span className={`${theme === 'light' ? 'bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent' : 'bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-t[...]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className={`glass rounded-2xl p-6 border ${theme === 'light' ? 'border-gray-200 bg-white/50' : 'border-white/20'} text-center`}>
              <div className={`w-16 h-16 ${theme === 'light' ? 'bg-gradient-to-r from-emerald-100 to-blue-100' : 'bg-gradient-to-r from-emerald-100/20 to-blue-100/20'} rounded-full flex items-center j[...]
      ...
      <footer className={`relative z-10 mt-16 border-t ${theme === 'light' ? 'border-gray-200 bg-white/20' : 'border-white/10 bg-black/20'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto px-4 py-12">
          {/* Changed from grid to flex for horizontal arrangement */}
          <div className="flex flex-col md:flex-row md:justify-between gap-8">
            ...
            <div className="space-y-4 md:w-1/3">
              ...
              {/* "Find Us" section with button */}
              <div className="space-y-2 mt-4">
                <h4 className={`font-semibold ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>Find Us</h4>
                <div className="flex items-center space-x-2">
                  <MapPin className="h-4 w-4" />
                  <span>Bhiman Sindhuli</span>
                  <a
                    href="https://maps.google.com/?q=Bhiman,Sindhuli,Nepal"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="ml-2 px-2 py-1 text-xs rounded bg-emerald-500 text-white hover:bg-emerald-600 transition-colors"
                  >
                    View Map
                  </a>
                </div>
