...
const Contacts = () => {
  ...
  if (loading) {
    return (
      <div
        className={`min-h-screen ${theme === "light" ? "bg-gradient-to-br from-gray-50 to-gray-100" : "bg-gradient-futuristic"} flex items-center justify-center`}
      >
    ...
    >
      ...
      {!backgroundImageUrl && (
        <div className="absolute inset-0">
          ...
          ></div>
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-128 h-128 bg-purple-500/10 rounded-full blur-3xl animate-float"
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 py-8 md:py-16">
        <div className="text-center mb-12 md:mb-16">
          <h1
            className={`text-4xl md:text-5xl lg:text-7xl font-black leading-tight mb-6 ${theme === "light" ? "text-gray-900" : "text-white"}`}
          >
            <span
              className={`${theme === "light" ? "bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent" : "bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent"}`}
            >
              Contact Us
            </span>
          </h1>
          ...
          >
            Ready to power your journey? Get in touch with our team for
            exceptional EV charging and hospitality services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 md:mb-16">
          <Card className="glass border border-white/20 backdrop-blur-xl bg-gray-900/50 text-center">
            <CardContent className="p-6 md:p-8">
              ...
              <h3
                className={`text-xl font-bold mb-2 ${theme === "light" ? "text-gray-900" : "text-white"}`}
              >
                Visit Us
              </h3>
              <p
              ...
              >
                {businessSettings.business_address || "Kathmandu, Nepal"}
                <br />
          ...
          <Card className="glass border border-white/20 backdrop-blur-xl bg-gray-900/50 text-center">
            <CardContent className="p-6 md:p-8">
              ...
              <p
                className={`${theme === "light" ? "text-gray-600" : "text-white/70"}`}
              >
                {businessSettings.contact_phone || "+977-1-XXXXXX"}
                <br />
                Available 24/7
              </p>
            </CardContent>
        ...
        {contacts.length > 0 && (
          <div className="mb-12 md:mb-16">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p
                className={`max-w-2xl mx-auto ${theme === "light" ? "text-gray-600" : "text-white/70"}`}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {contacts.map((contact) => (
                <Card
                  key={contact.id}
                  className="glass border border-white/20 backdrop-blur-xl bg-gray-900/50 hover:bg-gray-900/70 transition-all duration-300 hover:scale-105"
                >
                  <CardContent className="p-6">
                    <div className="text-center mb-4">
                      ...
                      <h3
                        className={`text-lg font-bold mb-1 ${theme === "light" ? "text-gray-900" : "text-white"}`}
                      >
                        {contact.name}
                      </h3>
                      {contact.position && (
                    ...
                    <div className="space-y-3">
                      {contact.email && (
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            className={`text-sm break-all ${theme === "light" ? "text-gray-700" : "text-white"}`}
                          >
                            {contact.email}
                          </span>
                        </div>
                      ...
                      {contact.phone && (
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            className={`text-sm ${theme === "light" ? "text-gray-700" : "text-white"}`}
                          >
                            {contact.phone}
                          </span>
                        </div>
        ...
        <div className="mb-12 md:mb-16">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p
              className={`max-w-2xl mx-auto mt-2 ${theme === "light" ? "text-gray-600" : "text-white/70"}`}
            >
              We'd love to hear about your experience at Energy Palace!
            </p>
          </div>
          <Card
            className={`glass border ${theme === "light" ? "border-gray-200 bg-white/70" : "border-white/20 bg-gray-900/70"} backdrop-blur-lg max-w-2xl mx-auto shadow-xl`}
          >
            <CardContent className="p-6 md:p-8">
              <SubmitReviewForm />
            </CardContent>
        ...
        <div className="text-center">
          <div className="glass border border-white/20 rounded-2xl p-6 md:p-12 backdrop-blur-xl">
            ...
            <p
              className={`mb-6 max-w-2xl mx-auto ${theme === "light" ? "text-gray-600" : "text-white/70"}`}
            >
              Experience the future of EV charging with our premium services.
              Book your charging session or make a restaurant reservation today.
            </p>
