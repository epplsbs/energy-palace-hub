          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">Bhiman Bazar, Sindhuli, Nepal</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-emerald-400" />
                <span className="text-gray-300 text-sm"> +9779851053261/+9779841426598 </span>
              </div>
              <div className="flex items-center space-x-3">
